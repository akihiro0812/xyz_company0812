            ...
            <div class="col-8">
                ...
                if(isset($_POST["submit"])) {
                    ...
                    <tr>
                        ...
                        <td> <?= number_format($employee->computeGrossIncome(), 2); ?>
                            <br>
                            <small class="text-muted fst-italic">
                                Regular Pay: (<?= $employee->getRegularHours() . "hrs" ?> x <?= $employee->getRegularRate(); ?>) + OT Pay: (<?= $employee->getOTHours() . "hrs"; ?> x <?= $employee->getOTRate(); ?>)
                    ...
                    <tr>
                        ...
                        <td>
                            <?= number_format($employee->computeNetIncome(), 2) ?>
                            <br>
                            <small class=""text-muted fst-italic">
