  ...
  class Employee {
    ...
    public function getRegularRate() {
      ...
      if($position == "staff" && $employment_status == "contractual") {
        return "300/day";
      } else if($position == "staff" && $employment_status == "probationary") {
        return "350/day";
      } else if($position == "staff" && $employment_status == "regular") {
        return "400/day";
      } else if($position == "admin" && $employment_status == "contractual") {
        return "350/day";
      } else if($position == "admin" && $employment_status == "probationary") {
        return "400/day";
      } else if($position == "admin" && $employment_status == "regular") {
        return "500/day";
      }
    }
    ...
    public function getHealthCare() {
      if($this->civil_status == 'single') {
        return 200;
      } else if($this->civil_status == 'married') {
        return 75;
      }
    }
    ...
    public function computeTax() {
      ...
      if(($this->civil_status == "single" && $grossIncome <= 1000)
          || ($this->civil_status == "married" && $grossIncome <=1500)) {
        return 0;
    } 
